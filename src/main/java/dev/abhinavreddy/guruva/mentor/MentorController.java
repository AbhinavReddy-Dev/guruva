...
//
    ...
    public ResponseEntity<ResponseBody> updateAvailability(@PathVariable ObjectId mentorId, @RequestBody boolean availability) throws Exception {
        System.out.println("Inside update availability: " + mentorId + " " + availability);
        Mentor mentor = mentorService.updateMentorAvailability(mentorId, availability);
